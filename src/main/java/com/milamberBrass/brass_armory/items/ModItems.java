...
public class ModItems {
    ...
    public static final RegistryObject<BABaseArrowItem> DIRT_ARROW =
            ITEMS.register("dirt_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.COMMON).tab(ModItemGroup.BRASS_ARMORY), ArrowType.DIRT));

    public static final RegistryObject<BABaseArrowItem> EX_ARROW =
            ITEMS.register("ex_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.RARE).tab(ModItemGroup.BRASS_ARMORY), ArrowType.EXPLOSION));

    public static final RegistryObject<BABaseArrowItem> FROST_ARROW =
            ITEMS.register("frost_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.UNCOMMON).tab(ModItemGroup.BRASS_ARMORY), ArrowType.FROST));

    public static final RegistryObject<BABaseArrowItem> GRASS_ARROW =
            ITEMS.register("grass_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.COMMON).tab(ModItemGroup.BRASS_ARMORY), ArrowType.GRASS));

    public static final RegistryObject<BABaseArrowItem> LASER_ARROW =
            ITEMS.register("laser_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.RARE).tab(ModItemGroup.BRASS_ARMORY), ArrowType.LASER));

    public static final RegistryObject<BABaseArrowItem> ROPE_ARROW =
            ITEMS.register("rope_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.UNCOMMON).tab(ModItemGroup.BRASS_ARMORY), ArrowType.ROPE));

    public static final RegistryObject<BABaseArrowItem> SLIME_ARROW =
            ITEMS.register("slime_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.UNCOMMON).tab(ModItemGroup.BRASS_ARMORY), ArrowType.SLIME));

    public static final RegistryObject<BABaseArrowItem> WARP_ARROW =
            ITEMS.register("warp_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.EPIC).tab(ModItemGroup.BRASS_ARMORY), ArrowType.WARP));

    public static final RegistryObject<BABaseArrowItem> FIRE_ARROW =
            ITEMS.register("fire_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.UNCOMMON).tab(ModItemGroup.BRASS_ARMORY), ArrowType.FIRE));

    public static final RegistryObject<BABaseArrowItem> CONCUSSION_ARROW =
            ITEMS.register("concussion_arrow", () ->
                    new BABaseArrowItem(new Item.Properties().rarity(Rarity.UNCOMMON).tab(ModItemGroup.BRASS_ARMORY), ArrowType.CONCUSSION));

    //               --------------------------BOOMERANG-------------------------------

    public static final RegistryObject<BowItem> WOOD_BOOMERANG =
            ITEMS.register("wood_boomerang", () ->
                    new BowItem(new Item.Properties().rarity(Rarity.COMMON).durability(384).tab(ModItemGroup.BRASS_ARMORY)));
    ...
    public static final RegistryObject<EggItem> BOMB =
            ITEMS.register("bomb", () ->
                    new EggItem(new Item.Properties().rarity(Rarity.RARE).tab(ModItemGroup.BRASS_ARMORY)));
    ...
    public static final RegistryObject<Spear> NETHERITE_SPEAR =
            ITEMS.register("netherite_spear", () -> new Spear(ItemTier.NETHERITE, 5,
                    new Item.Properties().rarity(Rarity.EPIC)
                            .durability(2031).tab(ModItemGroup.BRASS_ARMORY)));
    ...
    public static final RegistryObject<Dagger> NETHERITE_DAGGER =
            ITEMS.register( "netherite_dagger", () -> new Dagger(ItemTier.NETHERITE, 5,
                    new Item.Properties().rarity(Rarity.EPIC)
                            .defaultDurability(2031).tab(ModItemGroup.BRASS_ARMORY)));
