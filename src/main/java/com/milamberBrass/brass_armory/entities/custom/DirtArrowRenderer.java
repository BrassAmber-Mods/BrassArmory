...
public class DirtArrowRenderer<T extends AbstractArrowEntity> extends EntityRenderer<T> {
    public DirtArrowRenderer(EntityRendererManager renderManagerIn) {
    ...
    public ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(BrassArmory.MOD_ID + "item/projectile/dirt_arrow");
    }
